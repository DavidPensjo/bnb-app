  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-200 md:text-xl">
                  Discover amazing properties for your next getaway. Book with ease and enjoy your dream vacation.
                </p>
              </div>
              ...
              {[
                {
                  ...
                  description: "Choose from thousands of unique properties worldwide.",
                  icon: <MapPin className="h-10 w-10 mb-4 text-primary" />,
                },
                {
                  title: "Best Price Guarantee",
                  description: "Find the best deals and exclusive offers on vacation rentals.",
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-8">What Our Guests Say</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  name: "Alice Johnson",
                  comment: "Amazing experience! The property was even better than the pictures.",
                  avatar: "/placeholder.svg?height=40&width=40",
                },
                {
                  name: "Bob Smith",
                  comment: "Great customer service and a fantastic location. Will definitely book again!",
                  avatar: "/placeholder.svg?height=40&width=40",
                },
                {
                  name: "Carol Davis",
                  comment: "Seamless booking process and a wonderful stay. Highly recommended!",
                  avatar: "/placeholder.svg?height=40&width=40",
                },
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 VacayStay. All rights reserved.</p>
